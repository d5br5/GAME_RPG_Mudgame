...
const { constantManager } = require("../src/datas/Manager");
const mongoURI = process.env.mongoURI;
const { action } = require("../src/controller/action");
const { signup } = require("../src/controller/sign");
const { authentication } = require("../src/middle/auth");
const { ranking } = require("../src/controller/ranking");
